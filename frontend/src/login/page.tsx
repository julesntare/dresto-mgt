    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Restaurant Management System</p>
          <h2 className="mt-6 text-2xl font-bold text-gray-800 dark:text-gray-100">Sign in to your account</h2>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="you@example.com or +62812..."
                value={identifier}
