    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm">Sales and performance overview</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Daily Revenue</h2>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={formattedSales} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
                  ...
                  <YAxis tick={{ fontSize: 11, fill: tickColor }} tickFormatter={(v) => `${Math.round(v / 1000)}k`} />
        ...
        {/* Order Volume Chart */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Daily Order Volume</h2>
          {formattedSales.length === 0 ? (
            <EmptyChart />
          ) : (
            <div className="h-64">
      ...
      {orderTypeChartData.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Order Type Breakdown</h2>
            ...
            <div className="h-52">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis type="category" dataKey="name" tick={{ fontSize: 12, fill: tickColor }} width={70} />
                  <Tooltip formatter={(v: number) => [v, 'Orders']} />
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            {orderTypeChartData.map((t) => (
              <div key={t.name} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                ...
                <p className="text-lg font-bold text-gray-900 dark:text-white">{t.orders} orders</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">{formatCurrency(t.revenue)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Status Distribution */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Order Status Distribution</h2>
                  ...
                  <div key={item.menuItemId}>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-400 dark:text-gray-500">{formatCurrency(revenue)}</span>
                      </div>
                    </div>
